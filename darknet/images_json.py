...
for root, dirs, files in os.walk('./images'):
    ...
    for x, filename in enumerate(files):
        bashCommand = "darknet detector test data/coco.data yolov3_findpeaple.cfg yolov3_findpeaple_last.weights -thresh 0.35 {} -ext_output -dont_show -out result.json".format(filename)
